...
urlpatterns = [
               ...
               path('temples/<str:temple_pk>/posts/<str:pk>/destroy/', post_create_destroy, name='temple-post-destroy'),
               ...
               path('events/<str:event_pk>/posts/destroy/', post_create_destroy, name='event-post-destroy'),
