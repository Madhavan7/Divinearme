# Generated by Django 4.2.4 on 2023-08-08 03:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to='search.usermodel')),
            ],
        ),
        migrations.CreateModel(
            name='event',
        ...
        migrations.AddField(
            model_name='temple',
            name='invited_users',
            field=models.ManyToManyField(related_name='temple_invitations', through='search.TempleInvitation', to='search.usermodel'),
        ),
        migrations.CreateModel(
            name='EventPost',
            fields=[
        ...
        migrations.AddField(
            model_name='event',
            name='invited_users',
            field=models.ManyToManyField(related_name='event_invitations', through='search.EventInvitation', to='search.usermodel'),
        ),
        migrations.CreateModel(
            name='CommentReply',
            fields=[
